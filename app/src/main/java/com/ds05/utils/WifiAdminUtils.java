...
public class WifiAdminUtils {
     ...
     *
     */
    public boolean connect(String SSID, String Password, com.ds05.utils.WifiConnectUtils.WifiCipherType Type) {
        if (!this.openWifi()) {
            return false;
        }
    ...
    private WifiConfiguration createWifiInfo(String SSID, String Password,
                                             com.ds05.utils.WifiConnectUtils.WifiCipherType Type) {
        ...
        config.SSID = "\"" + SSID + "\"";
        if (Type == com.ds05.utils.WifiConnectUtils.WifiCipherType.WIFICIPHER_NOPASS) {
            config.wepKeys[0] = "";
            config.allowedKeyManagement.set(WifiConfiguration.KeyMgmt.NONE);
            config.wepTxKeyIndex = 0;
        }
        if (Type == com.ds05.utils.WifiConnectUtils.WifiCipherType.WIFICIPHER_WEP) {
        ...
        if (Type == com.ds05.utils.WifiConnectUtils.WifiCipherType.WIFICIPHER_WPA) {
            // 修改之后配置
            config.preSharedKey = "\"" + Password + "\"";
            config.hiddenSSID = true;
            config.allowedAuthAlgorithms
