		...
		while (true ) {
			...
			try {
				...
				if (session.isConnected()) {
					...
					String msg = "[" + System.currentTimeMillis() + ",T1,"+ Constants.SOFT_VERSION+","+Constants.ZHONGYUN_LINCESE+","+Constants.humanMonitorState+","+Constants.autoAlarmTime+","+Constants.monitorSensitivity+","+Constants.alarmMode+","+Constants.shootNumber+","+Constants.alarmSound+","+Constants.alarmSoundVolume+"]";
