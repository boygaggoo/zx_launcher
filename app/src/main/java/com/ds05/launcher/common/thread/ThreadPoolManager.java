package com.ds05.launcher.common.thread;

import android.util.Log;
import com.ds05.launcher.common.task.ThreadPoolTask;
...
public class ThreadPoolManager {
    ...
    public static ThreadPoolManager getInstance(){
        if (instance==null)
            instance=new ThreadPoolManager(ThreadPoolManager.TYPE_FIFO, 5);
        return instance;
    }
