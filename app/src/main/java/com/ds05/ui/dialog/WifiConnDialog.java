...
import com.ds05.ui.adapter.MyListViewAdapter;
import com.ds05.ui.api.OnNetworkChangeListener;
    ...
    private void setListener() {
        ...
        txtBtnConn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                com.ds05.utils.WifiConnectUtils.WifiCipherType type = null;
                if (scanResult.capabilities.toUpperCase().contains("WPA")) {
                    type = com.ds05.utils.WifiConnectUtils.WifiCipherType.WIFICIPHER_WPA;
                } else if (scanResult.capabilities.toUpperCase()
                        .contains("WEP")) {
                    type = com.ds05.utils.WifiConnectUtils.WifiCipherType.WIFICIPHER_WEP;
                } else {
                    type = com.ds05.utils.WifiConnectUtils.WifiCipherType.WIFICIPHER_NOPASS;
                }
                // 去连接网络
                com.ds05.utils.WifiAdminUtils mWifiAdmin = new com.ds05.utils.WifiAdminUtils(context);
                /**是否去连接了 */
...
//				return isConnect;
    ...
    private void initView() {
        ...
        txtSinglStrength.setText(com.ds05.utils.WifiAdminUtils.singlLevToStr(level));
